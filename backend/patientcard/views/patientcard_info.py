...
from patientcard.serializers.patientcard_info import PatientCardInfoSerializer
from patientcard.models import PatientCard


@extend_schema(
    tags=['Patient'],
    description="Returns patient card by card ID"
)
class PatientCardInfoView(GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if self.request.user.pk:
            patient_card = PatientCard.objects.select_related('patient__user').get(card_id=card_id)
